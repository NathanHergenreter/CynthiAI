...
table_record_file_dir = sys.path[0] + '/../TeamSelectionTable/Records/MoveSelectionTable.json'
...
def get_move_q_learner(alpha, discount):
    return QLearnerSimple(get_move_selection_table(), alpha, discount)
